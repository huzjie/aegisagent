"""Agno integration for AegisAgent.

Provides a governed agent wrapper for the Agno framework.
"""
...
__all__ = ["AegisAgnoAgent"]

_log = get_logger(__name__)


class AegisAgnoAgent(IntegrationBase):
    """Agno wrapper for AegisAgent governance.

    Wraps Agno to apply policy enforcement to tool calls.
    """
    ...
    def execute_tool(self, tool_name: str, tool_input: Dict[str, Any]) -> Any:
        ...
        """
        _log.info("agno tool call", fields={"tool": tool_name})
